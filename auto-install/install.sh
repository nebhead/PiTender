...
# Run from https://raw.githubusercontent.com/nebhead/pitender/master/auto-install/install.sh
#
...
whiptail --msgbox --backtitle "Welcome" --title "Automated Installer" "This installer will transform your Raspberry Pi into a smart automated bartender.  NOTE: This installer is intended to be run on a fresh install of Raspbian Lite Stretch.  This script is currently in Alpha testing so there may be bugs." ${r} ${c}
